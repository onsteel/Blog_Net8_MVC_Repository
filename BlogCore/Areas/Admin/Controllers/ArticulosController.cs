...
namespace BlogCore.Areas.Admin.Controllers
{
    ...
    {        
        ...
        {
            return Json(new { data = _contenedorTrabajo.Articulo.GetAll(includeProperties: "Categoria") });//Se pueden pasar varias tablas separadas por comas
        }

        [HttpDelete]
        public IActionResult Delete(int id)
        {
            var articuloDesdeDB = _contenedorTrabajo.Articulo.Get(id);//Obtengo el articulo desde db
